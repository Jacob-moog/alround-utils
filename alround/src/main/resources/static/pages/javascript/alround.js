...
import { searchBrand } from "./api/Search.js"
import { searchButton } from "./api/Search.js"
import { searchMotion } from "./api/Search.js"
...
export const ele={
   ...
   linkdisplay:document.querySelector(".link-display"),
}
function resize(){
  ...
  ele.results.style.gridTemplateColumns="repeat(2,180px)";
  ele.contentbtn.style.gridTemplateColumns="repeat(2,180px)";
  ele.contentbrands.style.gridTemplateColumns="repeat(2,180px)";

  ele.savecon.style.gridAutoRows="250px";

  ele.content.style.gridAutoRows="250px";
  ele.contentbtn.style.gridAutoRows="250px";
  ele.results.style.gridAutoRows="250px";
  ele.contentbrands.style.gridAutoRows="250px";
  ...
  ele.results.style.gridTemplateColumns="repeat(3,1fr)";
  ele.contentbrands.style.gridTemplateColumns="repeat(3,1fr)";

  ele.savecon.style.gridAutoRows="280px";
  ele.content.style.gridAutoRows="280px";
  ele.contentbtn.style.gridAutoRows="280px";
  ele.contentbrands.style.gridAutoRows="280px";
  ele.results.style.gridAutoRows="280px";
  ...
  ele.results.style.gridTemplateColumns="repeat(4,1fr)";
  ele.savecon.style.gridTemplateColumns="repeat(4,1fr)";
  ele.contentbrands.style.gridTemplateColumns="repeat(4,1fr)";

  ele.savecon.style.gridAutoRows="350px";
  ele.content.style.gridAutoRows="350px";
  ele.contentbtn.style.gridAutoRows="350px";
  ele.results.style.gridAutoRows="350px";
  ele.contentbrands.style.gridAutoRows="350px";
...
ele.copylink.addEventListener("click",()=>{
