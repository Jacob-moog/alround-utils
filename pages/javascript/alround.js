...
function resize(){
  ...
  ele.content.style.gridTemplateColumns="repeat(2,150px)";
  ele.content.style.margin="0px";
  ele.main.style.flexDirection="Column";
  ele.main.style.alignItems="center";
  ele.savecon.style.gridTemplateColumns="repeat(2,1fr)";
  
  }else if(window.innerWidth>600 && window.innerWidth<1000){

  ele.search.style.width="100%";
  ele.content.style.gridTemplateColumns="repeat(1,1fr)";
  ele.content.style.marginLeft="50px";
  ele.main.style.flexDirection="column";
  ele.main.style.alignItems="center";
  ...
  ele.savecon.style.gridTemplateColumns="repeat(8,1fr)";
