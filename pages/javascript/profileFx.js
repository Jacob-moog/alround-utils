...
export const displayProfileupdate=()=>{
  if(getComputedStyle(el.profileupdatepopup).display=="none"){
    el.profileupdatepopup.style.display="grid";
  }else{
  el.profileupdatepopup.style.display="none";
  }
};
